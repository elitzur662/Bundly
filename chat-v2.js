...
2 מסלולי הצטרפות לקבוצה:
- 🔔 עדכונים בלבד, חינם, רק התראות על הסבב, אין התחייבות, ללא הזנת כרטיס.
- ✅ הצטרפות לסבב, מזינים פרטי כרטיס אשראי לאימות תקינות הכרטיס בלבד, ללא חיוב וללא הקפאת סכום.
כשהסבב נסגר בהצלחה, התשלום מתבצע ישירות מול הספק, במלואו, בעמוד התשלום של הספק. בנדלי אינה גובה תשלומים ואינה מעבדת סליקה.
