  ...
  },
  {
    ...
    items: [
      { q: "איך אני מצטרף לקבוצה?",
        a: "בכל דף מוצר תראה כפתור 'הצטרף עכשיו'. תזין פרטי משלוח, נשמור את אמצעי התשלום שלך (בלי לחייב), ותעקוב אחרי ההתקדמות. כשהקבוצה תסגור, תקבל הודעה לאישור החיוב הסופי." },
      { q: "האם תחייבו את הכרטיס שלי כשאני נרשם?",
        a: "לא. אפס חיוב היום. אנחנו רק שומרים את הכרטיס דרך Stripe כדי לוודא שהוא תקף ולחייב אותו בעתיד אם הקבוצה תיסגר. הבנק עשוי להציג אישור $0 או $1 שמיד מתבטל." },
      { q: "מתי אני באמת אחויב?",
        a: "רק אחרי שני תנאים: (א) הקבוצה הצליחה, הגיעה למספר המינימלי של חברים. (ב) אישרת את החיוב במייל/SMS שתקבל. בלי שני האישורים, הכרטיס שלך לא ייגע." },
      { q: "מה אם לא אשים אישור?",
        a: "פשוט לא תחויב. תקבל תזכורת אחת או שתיים, ואם לא תאשר, אנחנו מבטלים את ההזמנה ואתה לא בקבוצה. לא קונסים אותך, לא לוקחים שום סכום." },
      { q: "מה זה אומר 'נעילת מחיר'?",
        a: "כשאתה בוחר באפשרות 'הצטרפות עם נעילת מחיר' (במקום רישום מקדים), המחיר הקבוצתי הנוכחי שמור עבורך. גם אם יצטרפו פחות אנשים והמחיר לא ירד, תשלם את המחיר שהיה ברגע ההצטרפות שלך, לא יותר." },
      { q: "מתי הקבוצה נסגרת?",
        a: "כשמגיעים למספר המינימלי של חברים שהוגדר במכרז, או בתאריך הסגירה, מה שמגיע קודם." },
      { q: "מה קורה אם הקבוצה לא נסגרת?",
        a: "שום דבר. הכרטיס שלך לא חויב בכלל, ואנחנו מוחקים את אמצעי התשלום מהמערכת (אלא אם תרצה לשמור אותו לפעם הבאה)." },
    ],
  },
  {
    id: "payment",
    ...
    items: [
      { q: "איך משלמים?",
        a: "כל התשלומים מבוצעים בכרטיס אשראי דרך Stripe, מעבד התשלומים הגדול בעולם, עם תקני PCI-DSS מלאים. אנחנו לא רואים את פרטי הכרטיס שלך בשום שלב." },
      { q: "איך עובד אישור החיוב לאחר סגירת קבוצה?",
        a: "ברגע שהקבוצה נסגרת בהצלחה, נשלח לך הודעה (אימייל + SMS) עם קישור לעמוד אישור. שם תראה: שם המוצר, המחיר הסופי שננעל, ארבע ספרות אחרונות של הכרטיס השמור, וכפתור 'אשר חיוב'. רק בלחיצה, נחייב את הכרטיס." },
      { q: "מה אם הכרטיס שלי נדחה?",
        a: "נשלח לך הודעה. תוכל לעדכן את אמצעי התשלום ולנסות שוב. אם לא תתקן תוך 48 שעות, ההזמנה מתבטלת אוטומטית והקבוצה ממשיכה בלעדיך." },
      { q: "מתי המוצר מגיע?",
        a: "מרגע שהחיוב מאושר, הספק מתחיל באריזה ושילוח. בדרך כלל המוצר מגיע תוך 5-10 ימי עסקים, בהתאם לסוג המוצר ולמיקום שלך. תקבל מספר מעקב לאחר השליחה." },
      { q: "האם יש דמי משלוח?",
